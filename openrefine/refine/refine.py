...
# import urllib.request from six
# import six.moves.urllib.request, six.moves.urllib.error, six.moves.urllib.parse

from . import facet
from . import history

REFINE_HOST = os.environ.get(
    'OPENREFINE_HOST', os.environ.get('GOOGLE_REFINE_HOST', '127.0.0.1'))
REFINE_PORT = os.environ.get(
    'OPENREFINE_PORT', os.environ.get('GOOGLE_REFINE_PORT', '3333'))
...
class RefineServer(object):
    ...
    def urlopen(self, command, data=None, params=None, project_id=None):
        ...
        # if response.info().get('Content-Encoding', None) == 'gzip':
            ...
            # gzip_fp = gzip.GzipFile(fileobj=io.BytesIO(response.read()))
...
class RefineProject:
    ...
    def apply_operations(self, file_path, wait=True):
        ...
        response_json = self.do_json(
            'apply-operations', {'operations': json_data})
